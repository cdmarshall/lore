...
- **"Omsite" = the consumer-facing Online Marketplace quoting experience.** The correct spelling is **Omsite**. Transcription software frequently mangles this word. When processing transcripts or ingesting documents, silently correct all of the following variants to "Omsite": `omnisite`, `OmniSite`, `Omnisite`, `omsi`, `OMSI`, `OMsite`, `OMSite`. Do not preserve the incorrect spelling in meeting notes, stakeholder files, or any other output.
